...
class TestServerUtils:
    ...
    def test_parse_cors_origins_custom(self):
        with patch.dict(
...
class TestServerEndpoints:
    ...
    def test_analyze_endpoint_success(self, mock_cache, mock_process, client):
    ...
    @patch("server.process_audio_file")
    @patch("server._get_from_cache")
    def test_analyze_endpoint_processing_error(self, mock_cache, mock_process, client):
        mock_cache.return_value = None  # Desabilitar cache
